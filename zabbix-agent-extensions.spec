...
%__install -dm 755 %{buildroot}/etc/zabbix/zabbix-agentd.d/
%__install -Dm 755 agent-scripts/agent-config/* %{buildroot}/etc/zabbix/zabbix-agentd.d/
...
%dir %{_bindir}
%{_bindir}/*
%dir %{_sysconfdir}/zabbix/zabbix-agentd.d/
%{_sysconfdir}/zabbix/zabbix-agentd.d/*
